...
@dsl.pipeline(
    ...
    description='Parallel pipeline for processing PDFs into embeddings + evaluation.'
)
def rag_pipeline(
    ...
    with dsl.ParallelFor(batch_list) as batch:
        ...
        kubernetes.set_security_context(ingest, run_as_non_root=True, run_as_user=1000)
        ...
        kubernetes.set_security_context(embed, run_as_non_root=True, run_as_user=1000)
        ...
        kubernetes.set_image_pull_policy(evaluate, 'Always')
        kubernetes.set_security_context(evaluate, run_as_non_root=True, run_as_user=1000)
